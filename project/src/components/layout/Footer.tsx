          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                <MapPin className="h-6 w-6 text-primary-500 mr-2 flex-shrink-0 mt-0.5" />
                <span className="text-gray-400">
                  PCET,s NMIET College, Vishnupuri, Talegaon-Dabhade
                </span>
              </li>
              <li className="flex items-center">
                <Phone className="h-6 w-6 text-primary-500 mr-2 flex-shrink-0" />
                <span className="text-gray-400">7397984292</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-6 w-6 text-primary-500 mr-2 flex-shrink-0" />
                <span className="text-gray-400">
                  prathameshyewale26@gmail.com
                </span>
              </li>
            </ul>
          </div>
